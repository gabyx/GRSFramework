...
public:
    ...
    {
        LOGSCLEVEL1(this->m_pSimulationLog,
                    "==== SettingsModuleMPI: parsing other options =====================" << std::endl;)
        ...
        if (!Utilities::stringToType(this->m_inclusionSettings->m_splitNodeUpdateRatio,
                                     incSet.attribute("splitNodeUpdateRatio").value()))
        {
            GRSF_ERRORMSG(
                "---> String conversion in MPISettings::InclusionSolverSettings: splitNodeUpdateRatio failed");
        }
        if (!Utilities::stringToType(this->m_inclusionSettings->m_convergenceCheckRatio,
                                     incSet.attribute("convergenceCheckRatio").value()))
        {
            GRSF_ERRORMSG(
                "---> String conversion in MPISettings::InclusionSolverSettings: convergenceCheckRatio failed");
        }
        ...
        if (att)
        {
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings::InclusionSolverSettings: m_reserveSplitNodes failed");
            }
        }
...
public:
    ...
    {
        LOGSCLEVEL1(this->m_pSimulationLog,
                    "==== ModuleMPI: parsing scene settings ============================" << std::endl;)
        ...
        else if (type == "dynamic")
        {
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings::ProcessTopology: policyCheckEveryXTimeStep failed");
            }
            ...
            {
                m_topoSettings->m_rebuildSettings.m_policy =
                    TopologyBuilderSettingsType::RebuildSettings::Policy::ALWAYS_REBUILD;
            }
            else if (type == "bodyLimit")
            {
                m_topoSettings->m_rebuildSettings.m_policy =
                    TopologyBuilderSettingsType::RebuildSettings::Policy::BODY_LIMIT;
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings:ProcessTopology: policy failed: not a valid setting");
            }
        }
        else
        {
        ...
        if (type == "grid")
        {
            ...
            if (att)
            {
                ...
                {
                    GRSF_ERRORMSG(
                        "---> String conversion in MPISettings::ProcessTopology: matchProcessDimToExtent failed");
                }
            }
            ...
            if (type == "predefined")
            {
                m_topoSettings->m_gridBuilderSettings.m_buildMode =
                    MPILayer::GridBuilderSettings::BuildMode::PREDEFINED;
                ...
                if (m_topoSettings->m_rebuildSettings.m_mode ==
                    TopologyBuilderSettingsType::RebuildSettings::Mode::DYNAMIC)
                {
                    GRSF_ERRORMSG(
                        "---> You defined a predefined grid as topology and using dynamic rebuilding! You should not "
                        "do this!")
                }
            }
            ...
            {
                m_topoSettings->m_gridBuilderSettings.m_buildMode =
                    MPILayer::GridBuilderSettings::BuildMode::BINET_TENSOR;
            }
            else if (type == "MVBB")
            {
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings:ProcessTopology:buildMode failed: not a valid setting");
            }
        ...
        else if (type == "kdTree")
        {
            ...
            if (type == "predefined")
            {
                m_topoSettings->m_kdTreeBuilderSettings.m_buildMode =
                    MPILayer::KdTreeBuilderSettings::BuildMode::PREDEFINED;
            ...
            {
                m_topoSettings->m_kdTreeBuilderSettings.m_buildMode =
                    MPILayer::KdTreeBuilderSettings::BuildMode::BINET_TENSOR;
            }
            else if (type == "MVBB")
            {
            ...
            {
                m_topoSettings->m_kdTreeBuilderSettings.m_buildMode =
                    MPILayer::KdTreeBuilderSettings::BuildMode::ALIGNED;
            }
            else
            {
                GRSF_ERRORMSG(
        ...
        if (massP)
        {
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings::ProcessTopology:MassPointPrediction nPoints failed");
            }
        ...
        if (outlier)
        {
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings::ProcessTopology:GlobalOutlierFilter kNNMean failed");
            }
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings::ProcessTopology:GlobalOutlierFilter stdDeviationMult "
                    "failed");
            }
            ...
            {
                GRSF_ERRORMSG(
                    "---> String conversion in MPISettings::ProcessTopology:GlobalOutlierFilter allowSplitAbove "
                    "failed");
            }
