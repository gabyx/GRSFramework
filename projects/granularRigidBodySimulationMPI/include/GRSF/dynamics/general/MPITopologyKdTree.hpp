...
private:
    ...
    */
    ...
    inline typename AdjacentNeighbourRanksMapType::mapped_type getCommonNeighbourCells(
        const NeighbourRanksListType& neighboursOurRanks, const SetType& neighboursOtherRank) const
    {
        ...
        std::set_intersection(neighboursOurRanks.begin(),
                              neighboursOurRanks.end(),
                              neighboursOtherRank.begin(),
                              neighboursOtherRank.end(),
    ...
    template <typename T>
    friend class TopologyVisitors::BelongsPointToProcess;
    template <typename T>
    friend class TopologyVisitors::CheckOverlap;
