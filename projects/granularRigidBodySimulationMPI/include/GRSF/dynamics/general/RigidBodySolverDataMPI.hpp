...
class RigidBodySolverDataCONoGMPI : public RigidBodySolverDataCONoG
{
    ...
    */
    PREC m_multiplicityWeight;    ///< This is the actual weight factor which is used by this process, to scale the mass
                                  /// matrix and the h vector!
    unsigned int m_multiplicity;  ///< This is the factor in how many virtual parts the body is split during the global
                                  /// inlcusion solving process
};
