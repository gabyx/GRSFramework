...
class NeighbourData
{
    ...
    inline LocalIterator localBegin()
    {
        return m_localDataMap.begin();
    }
    inline RemoteIterator remoteBegin()
    {
        return m_remoteDataMap.begin();
    }
    inline LocalIterator localEnd()
    {
        return m_localDataMap.end();
    }
    inline RemoteIterator remoteEnd()
    {
        return m_remoteDataMap.end();
    }

    inline std::pair<LocalDataType*, bool> addLocalBodyData(RigidBodyType* body)
    {
        auto resPair = m_localDataMap.insert(typename LocalDataMapType::value_type(body->m_id, LocalDataType(body)));
    ...
    {
        // <iterator,bool>
        auto resPair = m_remoteDataMap.insert(typename RemoteDataMapType::value_type(body->m_id, RemoteDataType(body)));
