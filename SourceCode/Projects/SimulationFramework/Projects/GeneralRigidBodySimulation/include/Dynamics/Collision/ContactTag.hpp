...
ContactTag makeContactTag(RigidBodyBase<TLayoutConfig>* b1, unsigned char type1, unsigned int id1, RigidBodyBase<TLayoutConfig>* b2 , unsigned char type2 , unsigned int id2)
{
