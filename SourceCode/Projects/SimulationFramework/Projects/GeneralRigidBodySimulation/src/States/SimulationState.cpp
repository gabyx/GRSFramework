...
{
  RenderContext::getSingletonPtr()->m_pAppLog->logMessage("Pausing SimulationState...");
...
void SimulationState::updateParamsPanelSimulation(){
  ...
  if(iterations%50==0){
    ...
    GlobalTimeText.str(""); DynamicsThreadTimeText.str(""); SimTimeText.str(""); DelayText.str("");  TimeFactorText.str(""); AverageIterTimeText.str(""); MaxIterTimeText.str(""); NContactsText.str("");
