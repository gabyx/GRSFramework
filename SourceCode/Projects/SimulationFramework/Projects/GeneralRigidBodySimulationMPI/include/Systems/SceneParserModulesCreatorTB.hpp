#ifndef SceneParserModulesCreatorTB_hpp
#define SceneParserModulesCreatorTB_hpp
...
struct ParserModulesCreatorTopoBuilder{
    ...
    createParserModules(TParser * p) {
        ...
        auto is  = std::unique_ptr<InitStatesModuleType >(new InitStatesModuleType(p, &m_p->m_initStates,nullptr ));
