...
#ifndef GMSF_Dynamics_General_MeshData_hpp
#define GMSF_Dynamics_General_MeshData_hpp
...
//   };
   ...
   bool setup( Assimp::Importer & importer, const aiScene* scene, Vector3 scale_factor, Quaternion quat, Vector3 trans){
    Matrix33 Rot_KI = quat.matrix();//QuaternionHelpers::getRotFromQuaternion<PREC>(quat);
