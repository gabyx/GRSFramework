#ifndef GMSF_Dynamics_Buffers_StateRecorderProcess_hpp
#define GMSF_Dynamics_Buffers_StateRecorderProcess_hpp
...
#include "GMSF/Dynamics/General/MultiBodySimFilePart.hpp"
