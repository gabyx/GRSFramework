#ifndef GMSF_Common_ColorGradient_hpp
#define GMSF_Common_ColorGradient_hpp
...
private:
    ...
    struct ColorPoint { // Internal class used to store m_colors at different points in the gradient.
        ...
        ColorPoint(Vector3 rgb, PREC value)
            : m_rgb(rgb), m_val(value) {}
    };
