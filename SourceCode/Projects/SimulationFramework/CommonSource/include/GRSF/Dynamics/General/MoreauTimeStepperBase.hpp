...
public:
    ...
    MoreauTimeStepperBase(std::shared_ptr<DynamicsSystemType> pDynSys);
    ~MoreauTimeStepperBase();
...
#include "GRSF/Dynamics/General/MoreauTimeStepperBase.icc"
