...
public:
    ...
    FrontBackBuffer(boost::shared_ptr<TBufferType> pfront, boost::shared_ptr<const TBufferType> pback)
    {
        m_pFront = pfront;
        m_pBack  = pback;
    };
...
public:
    ...
    FrontBackBuffer(TBufferType* pfront, const TBufferType* pback)
    {
        m_pFront = pfront;
        m_pBack  = pback;
    };
