...
static void inline doProxSingle1(  const PREC & radius, const Eigen::MatrixBase<Derived> & y,
...
template<typename PREC, typename Derived>
static void inline doProxSingle2(  const PREC & radius, const Eigen::MatrixBase<Derived> & y,
                                   Eigen::MatrixBase<Derived> & out) {
...
template<typename PREC, typename Derived>
static void inline doProxSingle3(  const PREC & radius, const Eigen::MatrixBase<Derived> & y,
                                    Eigen::MatrixBase<Derived> & out) {
...
template<typename PREC, typename Derived>
static void inline doProxSingle4(  const PREC & radius, const Eigen::MatrixBase<Derived> & y,
                                   Eigen::MatrixBase<Derived> & out) {
