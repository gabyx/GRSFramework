...
int contactGraphTest()
{
    ...
    int size = 1000000;
    {
        using cg = GraphTraitsSymmetric< meta::list<NodeDataA,NodeDataB,NodeDataC>, meta::list<EdgeDataAA,EdgeDataAB,EdgeDataAC,EdgeDataBB,EdgeDataBC,EdgeDataCC> >;
      ...
      {
        using cg = GraphTraitsSymmetric< meta::list<NodeDataA,NodeDataB,NodeDataC>, meta::list<EdgeDataAA,EdgeDataAA,EdgeDataAA,EdgeDataAA,EdgeDataAA,EdgeDataAA> >;
...

    {
...

     {
        ...
        using cg = GraphTraitsSymmetric< meta::list<NodeDataA,NodeDataB,NodeDataC>, meta::list<void,void,EdgeDataAC,void,void,EdgeDataCC> >;
        ...
        a->addEdgeIn(edge); a->addEdgeOut(edge);
     ...
     {
        using cg = GraphTraitsSymmetric< meta::list<NodeDataA,NodeDataB,NodeDataC>, meta::list<void,void,void,void,void,void> >;
