    ...
    public:
        ...
        */
        ...
        bool operator==(const Iterator &rhs) {
                if(m_rangePtr == rhs.m_rangePtr && m_rangePtr ) { // if sequences are the same
...
struct ComboTypes {
    ...
    using ComboType = boost::variant< typename ListTypes<Type>::ContainerType, typename RangeTypes<Type>::ContainerType > ; // Indexes into the variants are defined above!
    ...
    public:
        ...
        */
        ...
        bool operator==(const Iterator &rhs) {
            // if wrong type or if sequence pointers are not the same or one pointer is NULL, the iterators can not be the same!
            if(m_which != rhs.m_which || m_comboRangePtr != rhs.m_comboRangePtr ||
                    m_comboRangePtr   == nullptr || rhs.m_comboRangePtr   == nullptr ||
                    m_comboRangeItPtr == nullptr || rhs.m_comboRangeItPtr == nullptr) {
                return false;
            }
