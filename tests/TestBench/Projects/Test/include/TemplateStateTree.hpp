...
/** Leaf Type Getter ====================================================================================*/
    ...
    struct getLeafType_imp<N,CurrLeafIdx,ChildIdx,TState, typename std::enable_if< ( ChildIdx < TState::NStates) >::type > {
        ...
        using type = typename    std::conditional<
                                    ...
                                    typename getLeafType_imp<N,
                                                             CurrLeafIdx + TupleElement::NLeafs,
                                                             ChildIdx+1,
                                                             TState
                                                            >::type
                                    ,
...
/** Leaf Getter ====================================================================================*/
    ...
    struct Traversal{
        ...
        >
        static auto visit(TState & state) -> typename getLeafType_imp<  N,
                                                                        CurrLeafIdx + TupleElement::NLeafs,
                                                                        ChildIdx+1,
                                                                        TState
                                                                     >::type &
    ...
    template<unsigned int ChildIdx,
             typename T>
    ...
    template<unsigned int N,
             typename TState
             >
    typename getLeafType<N,TState>::type &
    getLeaf_imp(TState & state){
...
struct State{
    ...
    /** Type Getter =============================================================*/
        template<unsigned int N, typename Enable = void > struct getType;
    ...
    /** Leaf Value Getter for this State ==============================================================*/
        template<unsigned int N>
        typename getLeafType<N,State>::type &
        getLeaf(){
...
namespace TemplateTree2{
    ...
    template<typename... States> struct State;
    ...
    /** Leaf Type Getter ====================================================================================*/
        ...
        struct getLeafType_imp<  State<Args...> > {
            ...
            struct defineType<N,ChildIdx, typename std::enable_if< ( ChildIdx < TState::NStates) >::type >{
                ...
                using type = typename    std::conditional<
                                            (N >= NLeafsElement ),   // if current global leaf index N at TState > child::NLeafs then
                                            ...
                                            typename getLeafType_imp<ChildElement>::template defineType<N,0>::type
                                          >::type;
    ...
    /** Leaf Getter ====================================================================================*/
        ...
        struct LeafGetter< State<Args...> > {
            ...
            template<unsigned int N, unsigned int ChildIdx>
            struct getter<N,ChildIdx, typename std::enable_if< !(N >= getNLeafs< typename TState::template getType<ChildIdx>::type >::value ) >::type >
            {
        ...
        template<unsigned int N, typename TState , typename std::enable_if< (N >= TState::NLeafs )>::type * = nullptr>
        typename getLeafType<0,TState>::type &
        getLeaf_imp(TState & state){
    ...
    struct State{
        ...
        /** Leaf Value Getter for this State (complicated) ============================*/
            template<unsigned int N>
            auto
            getLeaf() -> decltype(getLeaf_imp<N,State>(*this)) {
                return getLeaf_imp<N,State>(*this);
            }
        /*=============================================================================*/
