...
public:
    ...
    */
    ...
    OOBB computeMVBB(const Vector3 & zDir,
        ...
        //        // DEBUG
        //        PointFunctions::dumpPoints("./computeMVBBIn.txt",m_p);
        ...
        //        Vector2List p;
        //        p.push_back( box.m_p);
        //        p.push_back( box.m_p + box.m_u );
        //        p.push_back( box.m_p + box.m_u + box.m_v );
        //        p.push_back( box.m_p + box.m_v );
        //        p.push_back( box.m_p);
        //        PointFunctions::dumpPoints("./computeMVBBRect.txt",p);
...
private:
    ...
    void project(const MatrixBase<Derived> & points) {
        ...
        GRSF_ASSERTMSG(checkOrthogonality(xDir,yDir,m_zDir,1e-6),
