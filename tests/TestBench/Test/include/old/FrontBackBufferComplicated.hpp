...
int frontBackBufferTest()
{
...

    {
        ...
        buf1.swap();
        CHECK_TEST(buf1.getBack() == 1 && buf1.getFront() == 3 && buf1.getBack() == front && buf1.getFront() == back,
                   CheckNr);

        CheckNr++;
        buf1.getBack() = 4;
        CHECK_TEST(buf1.getBack() == 4 && buf1.getFront() == 3 && buf1.getBack() == front && buf1.getFront() == back,
                   CheckNr);

        CheckNr++;
        buf1.getBack() = 6;
        CHECK_TEST(buf1.getBack() == 6 && buf1.getFront() == 3 && buf1.getBack() == front && buf1.getFront() == back,
                   CheckNr);

        CheckNr++;
        buf1.swap();
        CHECK_TEST(buf1.getBack() == 3 && buf1.getFront() == 6 && buf1.getBack() == back && buf1.getFront() == front,
                   CheckNr);
    }

    {
        ...
        buf1.swap();
        CHECK_TEST(buf1.getBack() == 5 && buf1.getFront() == 3 && buf1.getBack() == front && buf1.getFront() == back,
                   CheckNr);
...

    {
        ...
        buf1.getBack()  = 2;
        buf1.getFront() = 3;
        CHECK_TEST(buf1.getBack() == 2 && buf1.getFront() == 3 && buf1.getBack() != back && buf1.getFront() == front,
                   CheckNr);

        CheckNr++;
        buf1.swap();
        CHECK_TEST(buf1.getBack() == 3 && buf1.getFront() == 2 && buf1.getBack() == front && buf1.getFront() != back &&
                       buf1.getFront() != front,
                   CheckNr);
    }

    {
        ...
        CHECK_TEST(buf1.getBack() == 3 && buf1.getFront() == 4 && buf1.getBack() != back && buf1.getFront() == front &&
                       buf1.getFront() != back,
                   CheckNr);
    }

    {
        ...
        CHECK_TEST(buf1.getBack() == 5 && buf1.getFront() == 6 && buf1.getBack() == *b_ptr && buf1.getFront() == *f_ptr,
                   CheckNr);

        CheckNr++;
        buf1.swap();
        CHECK_TEST(buf1.getBack() == 6 && buf1.getFront() == 5 && buf1.getBack() == *f_ptr && buf1.getFront() == *b_ptr,
                   CheckNr);
    }
