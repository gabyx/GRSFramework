...
{
    static const Vector3Spec& get(const MyPoint& p)
    {
        return *(p.m_p);
    }
    static Vector3Spec& get(MyPoint& p)
    {
        return *(p.m_p);
    }
};
...
{
    static const Vector3Spec& get(const MyPoint2& p)
    {
        return p.m_p;
    }
    static Vector3Spec& get(MyPoint2& p)
    {
        return p.m_p;
    }
};
...
void pointCloudTest()
{
    ...
    //            //std::cout << "kNearest My time: " << count2 << " sec. (point: " <<
    //            kNearest.getComperator().m_ref.transpose() << ")" << std::endl;
    //
    ...
    //                        std::cout <<"i:" << (i++) << " " << p.m_id << " : " << p.m_p->transpose() << " dist: " <<
    //                        compDist(p) <<  std::endl;
    //                    }
    //                    i = 0;
    ...
    //                        //std::cout << " : " << p.transpose() << " dist: " << compDist(p) <<  std::endl;
    //                        std::cout <<"i:" << (i++) << " " << g->m_id << " : " << g->m_p->transpose() << " dist: "
    //                        << compDist(*g) <<  std::endl;
    //                    }
    //
