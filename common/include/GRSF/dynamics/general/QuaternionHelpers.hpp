...
// template<class Derived, class DerivedOther>
// void setQuaternion(const Eigen::MatrixBase<Derived>& nc_quat , const Eigen::MatrixBase<DerivedOther> & nc_n, const
// typename Derived::Scalar angleRadian) {
//    using PREC = typename Derived::Scalar;
//    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(Derived,4);
...
template <class Derived, class DerivedOther>
void rotateVector(const Eigen::MatrixBase<Derived>& quat, Eigen::MatrixBase<DerivedOther>& v)
{
    using PREC = typename Derived::Scalar;
    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(Derived, 4);
    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(DerivedOther, 3);
