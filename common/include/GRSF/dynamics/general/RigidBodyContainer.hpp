    ...
    typedef boost::multi_index::multi_index_container<
        ...
        boost::multi_index::indexed_by<
            ...
            boost::multi_index::hashed_unique<boost::multi_index::tag<by_hashed_id>,
                                              boost::multi_index::member<RigidBodyType::AbsoluteBaseType,
                                                                         const RigidBodyIdType,
                                                                         &RigidBodyType::AbsoluteBaseType::m_id>>,
            boost::multi_index::ordered_unique<boost::multi_index::tag<by_ordered_id>,
                                               boost::multi_index::member<RigidBodyType::AbsoluteBaseType,
                                                                          const RigidBodyIdType,
                                                                          &RigidBodyType::AbsoluteBaseType::m_id>>>>
        MapType;
...
private:
    ...
    {
        const RigidBodyIdType& operator()(const typename Iter::value_type& pBody) const
        {
            return pBody->m_id;
        }
    };
