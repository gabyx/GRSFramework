...
/**
      ...
      * This function applies for triplets, the first value is proxed onto \f$ C_1 \f$  and the second to values in
 * sequence are proxed on to the Contensou ellipsoid.
      */
