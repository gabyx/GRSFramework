...
#if HAVE_CUDA_SUPPORT == 1
    JorProxGPUVariant<JorProxGPUVariantSettingsWrapper<PREC,
                                                       5,
                                                       ConvexSets::RPlusAndDisk,
                                                       true,
                                                       300,
                                                       true,
                                                       10,
                                                       false,
                                                       TypeTraitsHelper::Default>,
                      ConvexSets::RPlusAndDisk>
        m_jorGPUVariant;
    // SorProxGPUVariant< SorProxGPUVariantSettingsWrapper<PREC,5,ConvexSets::RPlusAndDisk,true,300,true,10,true,
    // RelaxedSorProxKernelSettings<32,ConvexSets::RPlusAndDisk> >,  ConvexSets::RPlusAndDisk > m_sorGPUVariant;
    SorProxGPUVariant<SorProxGPUVariantSettingsWrapper<PREC,
                                                       1,
                                                       ConvexSets::RPlusAndDisk,
                                                       true,
                                                       300,
