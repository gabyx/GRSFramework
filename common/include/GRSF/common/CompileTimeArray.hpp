...
* Take care: using A = CompileTimeArray::Array<count, GenA>;  and  using B = CompileTimeArray::Array<count, GenA>;
*somewhere else
...
template <typename T>
struct is_allowed_instantiation
{
    static const bool value = true;
};
template <size_t S>
struct is_allowed_instantiation<CompileTimeArray::RangeGenerator<S>>
{
